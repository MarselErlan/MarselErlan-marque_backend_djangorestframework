    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_country', models.CharField(default='Kyrgyzstan', max_length=100)),
                ...
                ('payment_method', models.CharField(choices=[('card', 'Credit/Debit Card'), ('cash', 'Cash on Delivery'), ('transfer', 'Bank Transfer'), ('digital_wallet', 'Digital Wallet')], default='cash', max_length=20)),
