# Generated by Django 5.2.8 on 2025-11-06 03:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('market', models.CharField(db_index=True, default='KG', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active_market', models.CharField(default='KG', max_length=2)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('manager', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='settings', to='store_manager.storemanager')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manager', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notifications', to='store_manager.storemanager')),
            ],
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['manager', 'is_read', '-created_at'], name='manager_not_manager_769032_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action_type', models.CharField(choices=[('view_order', 'Viewed Order'), ('update_status', 'Updated Order Status'), ('cancel_order', 'Cancelled Order'), ('resume_order', 'Resumed Order'), ('export_data', 'Exported Data'), ('view_revenue', 'Viewed Revenue'), ('switch_market', 'Switched Market'), ('login', 'Logged In'), ('logout', 'Logged Out')], db_index=True, max_length=20)),
                ('market', models.CharField(blank=True, max_length=2, null=True)),
                ...
                ('manager', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='activity_logs', to='store_manager.storemanager')),
            ],
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['manager', '-created_at'], name='manager_act_manager_0dd6dc_idx'), models.Index(fields=['action_type', '-created_at'], name='manager_act_action__26fde4_idx')],
            },
        ),
        migrations.CreateModel(
            name='DailyReport',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('market', models.CharField(default='KG', max_length=2)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('manager', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reports', to='store_manager.storemanager')),
            ],
            options={
